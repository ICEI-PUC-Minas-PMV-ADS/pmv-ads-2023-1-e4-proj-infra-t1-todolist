...
import { addTask } from "../../services/consumerApi";
export default function ModalTask({ visible, onResquetClose, userLogado, token }) {
    ...
    const criarTarefa = async () => {
        ...
        await addTask(token, tarefaObj)
            .then((response) => {
                ...
                Alert.alert('Não foi possivel adicionar a tarefa!');
                console.log(error);
            })
    }
            ...
            <View style={styles.modal}>
                <View style={styles.modalContent}>
                    ...
                    <View style={styles.modalButtons}>
                        ...
                        <TouchableOpacity onPress={criarTarefa} style={styles.btModal}><Text style={styles.textBtModal}>Salvar</Text></TouchableOpacity>
