...
| **Motivações para frequentar algum estabelecimento:**<br><ul>● Programar a agenda da semana. <br>● Otimizar o fluxo de trabalho.</ul> | **Frustrações:**<br><ul>● Falta de controle das horas gastas em cada tarefa.</ul> | **Hobbies:**<br><ul>● Ler livros<br>● Jogar futebol <br>● Ver séries</ul>             |
